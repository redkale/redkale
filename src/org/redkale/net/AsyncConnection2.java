...
public abstract class AsyncConnection2 implements ReadableByteChannel, WritableByteChannel, AutoCloseable {
    ...
    protected Consumer<AsyncConnection2> beforeCloseListener;

    //关联的事件数， 小于1表示没有事件
    protected final AtomicInteger eventing = new AtomicInteger();

    protected AsyncConnection2(Supplier<ByteBuffer> bufferSupplier, Consumer<ByteBuffer> bufferConsumer) {
    ...
    public AsyncConnection2 beforeCloseListener(Consumer<AsyncConnection2> beforeCloseListener) {
